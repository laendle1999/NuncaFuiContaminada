...
write.csv(out_evolucao, '~/Área de Trabalho/covid/Novo/out_evolucao1_datas.csv')

write.csv(out_uti, '~/Área de Trabalho/covid/Novo/out_uti_datas1.csv')
...
write.csv(train_cl1, '~/Área de Trabalho/covid/Novo/treino_evolucao12_datas.csv')
write.csv(test_cl1, '~/Área de Trabalho/covid/Novo/teste_evolucao12_datas.csv')

write.csv(train_cl2, '~/Área de Trabalho/covid/Novo/treino_UTI12_datas.csv')
write.csv(test_cl2, '~/Área de Trabalho/covid/Novo/teste_UTI12_datas.csv')
