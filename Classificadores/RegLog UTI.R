...
print("Regressão logistica - Evolução")
...
train_cl1 = subset(train_cl1, select = c(-UTI, -NU_IDADE_N, -DIAS_SINTOMAS,
                                         -DIAS_SINTOMAS_A_INTERNAR, 
                                         -DIAS_INTERNACAO, -HOSPITAL, -X))
test_cl1 = subset(test_cl1, select = c(-UTI, -NU_IDADE_N, -DIAS_SINTOMAS, 
                                       -DIAS_SINTOMAS_A_INTERNAR, 
                                       -DIAS_INTERNACAO, -HOSPITAL, -X))
...
#remover gestaçao baixo valor de pvalue (EX: CS_GESTANT, VOMITO, PUERPERA, 
#CARDIOPATI) E com 
#alta multicolineariedade (DIAS_INTERNACAOcat,  DIAS_SINTOMAScat  )

train_cl1 = subset(train_cl1, select = c( -DESC_RESP, -HEMATOLOGI, -CS_GESTANT,
                                         -HEPATICA, -ASMA, -NEUROLOGIC,
                                         -PNEUMOPATI, 
                                         -DIAS_INTERNACAOcat, -DIAS_SINTOMAScat  
))

test_cl1 = subset(test_cl1, select = c( -DESC_RESP, -HEMATOLOGI, -CS_GESTANT,
                                        -HEPATICA, -ASMA, -NEUROLOGIC,
                                        -PNEUMOPATI, 
                                       -DIAS_INTERNACAOcat, -DIAS_SINTOMAScat  
))
